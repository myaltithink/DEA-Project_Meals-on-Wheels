...
@section('content')
    <div class="m-4 m-md-5">
        ...
        <p>These terms and conditions outline the rules and regulations for the use of MerryMeals's Website, located at
            http://localhost:8000.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Meals on Wheels
            if
        ...
        <p>We employ the use of cookies. By accessing Meals on Wheels, you agreed to use cookies in agreement with the
            MerryMeals's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, MerryMeals and/or its licensors own the intellectual property rights for all material on
            Meals on Wheels. All intellectual property rights are reserved. You may access this from Meals on Wheels for
            your
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas
            of the website. MerryMeals does not filter, edit, publish or review Comments prior to their presence on the
            website.
            Comments do not reflect the views and opinions of MerryMeals,its agents and/or affiliates. Comments reflect the
            views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws,
            MerryMeals shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered
            as
            a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

        <p>MerryMeals reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant MerryMeals a non-exclusive license to use, reproduce, edit and authorize others to use,
            reproduce
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            records
            with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of MerryMeals; and
            (d)
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
            must inform us by sending an e-mail to MerryMeals. Please include your name, your organization name, contact
        ...
        <p>No use of MerryMeals's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
