        ...
        @forelse ($pendingOrders as $order)
            <div class = "card col-12 px-2 pb-3">
                ...
                <div class = "card-footer bg-transparent border-0 d-flex justify-content-end">
                    <button class ="btn btn-outline-primary px-5 py-2" data-bs-toggle="modal" data-bs-target="#select-to-prepare" data-select-order = "{{ $order->meal_order_id }}">
                        Assign To
                    </button>
                </div>
            </div>
...
@endsection
@section('modals')
    <div class="modal fade" data-bs-backdrop="static" id = "select-to-prepare">
