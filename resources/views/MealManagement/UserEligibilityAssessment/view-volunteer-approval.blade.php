...
@section('subcontent')
    <div class="container my-5">
        <h1 class="text-center fw-bold">Volunteer Approval</h1>
        <div class="row my-3 justify-content-center">
          <div class="col-md-6 bg-white shadow rounded mx-2 my-2 border border-dark">
            <div class="mx-3 my-4">
                {{-- volunteer's profile information --}}
                <div class="">
                    <h4><strong>Profile</strong></h4>
                    <div class="mx-2">
                        <div class="row" style="font-size: 18px">
                            <div class="col-md-6">
                                <p><strong>Name:</strong> {{ ucwords($details->volunteer_name) }}</p>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <p><strong>Role:</strong> {{ ucwords($details->volunteer_role) }} </p>
                            </div>
                        </div>
                    </div>
                </div>

                {{-- volunteer's organization information --}}
                <div>
                    <h4><strong>Organization</strong></h4>
                    <div class="mx-2">
                        <div class="row" style="font-size: 18px">
                            <div class="col-md-6">
                                <p><strong>Name:</strong> {{ ucwords($details->organization_name) }}</p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>Address:</strong> {{ ucwords($details->organization_address) }} </p>
                            </div>
                        </div>
                    </div>
                </div>

                {{-- volunteer's proof of identity --}}
                <div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <h3 class="mt-3"><strong> Approve this volunteer? </strong></h3>
        </div>
        <div class="d-flex justify-content-center mb-4">
          <button type="button" class="btn btn-secondary mx-2" data-bs-dismiss="modal">CLOSE</button>
          <form method="POST" action ="{{ route('approve-volunteer') }}">
            @csrf
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <h3 class="mt-3"><strong> Reject this volunteer? </strong></h3>
        </div>
        <form method="POST" action ="{{ route('reject-volunteer') }}">
          @csrf
