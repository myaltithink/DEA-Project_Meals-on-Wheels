          ...
          <div class="col-md-6 bg-white shadow rounded mx-2 my-2 border border-dark">
            <div class="thumbnail mt-2">
                <div class="text-center mt-5">
                    <img src="{{ asset('storage/foods/'.$proposal->meal_image_path) }}" alt="Meal Proposal" class="w-25 h-25">
                </div>
                ...
                <div style="float: right;" class="mb-4 mx-3">
                    ...
                    <button class = "btn btn-danger mx-1" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">
                        REJECT
                    </button>
               </div>
